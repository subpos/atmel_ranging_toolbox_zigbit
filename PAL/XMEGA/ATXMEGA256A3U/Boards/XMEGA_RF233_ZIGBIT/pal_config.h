 ...
 * @file pal_config.h
 *
 * @brief PAL configuration for ATxmega256A3U
 *
 * This header file contains configuration parameters for ATxmega256A3U.
 *
...
/**
 * This board doesn't use Antenna Diversity.
 ...
 */
#define BUTTON_PIN_0_CTRL               (BUTTON_PORT.PIN2CTRL)
 ...
 * here: UART 1 is located at port D, pin 2 and 3
 */
...
/*
 * Timer macros for ATxmega256A3U
 */
 ...
 */
//https://books.google.com/books?id=TSYLAAAAQBAJ&pg=PA413&lpg=PA413&dq=TC+CLKSEL+xmega&source=bl&ots=KnGZzxHQej&sig=zZeVLQxfHBUZ0r1zWEoRrYo50n0&hl=en&sa=X&ved=0ahUKEwj2saix3aHKAhXGKWMKHfWVD74Q6AEIKzAD#v=onepage&q&f=false
//#ifndef EXTERNAL_OSC
//Use event timer 2 (1010)
#define TIMER_SRC_DURING_TRX_AWAKE() {TCC0_CTRLA = TC0_CLKSEL3_bm | TC0_CLKSEL1_bm; \
        TCC1_CTRLA = TC1_CLKSEL3_bm | TC1_CLKSEL1_bm;}
//#else
		//Use Event timer 0 only (1000)
//		#define TIMER_SRC_DURING_TRX_AWAKE() {TCC0_CTRLA = TC0_CLKSEL3_bm; 
...
/*
 * TRX Access macros for ATxmega256A3U
 */
...
#endif
#ifndef USER_SIGN_AVAILABLE
#define USER_SIGN_AVAILABLE           (1)
#endif
